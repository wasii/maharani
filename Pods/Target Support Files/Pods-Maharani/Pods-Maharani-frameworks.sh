...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/AKMonthYearPickerView/AKMonthYearPickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DPOTPView/DPOTPView.framework"
