...
public class AKMonthYearPickerView: UIView {
    ...
    public static var sharedInstance   = {
        return AKMonthYearPickerView(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 256)), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 216)))
    }()
    ...
    convenience init() {
        let frame = CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 256)), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 216))
    ...
    private func getToolBar() -> UIToolbar {
        ...
        let customToolbar          = UIToolbar(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 256)), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 40)))
...
private class MonthYearPickerView: UIPickerView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    static var sharedInstance   = {
        return MonthYearPickerView(frame: CGRect(origin: CGPoint(x: 0, y: (AKMonthYearPickerConstants.AppFrameSettings.screenHeight - 256)), size: CGSize(width: AKMonthYearPickerConstants.AppFrameSettings.screenWidth, height: 216)))
    }()
